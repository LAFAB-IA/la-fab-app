    ...
    return (
        <div style={{ fontFamily: "Inter, sans-serif", boxSizing: "border-box" }}>
            <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                ...
                {/* Table */}
                <div style={{ backgroundColor: C.white, borderRadius: 12, boxShadow: "0 1px 3px rgba(58,64,64,0.08)", border: "1px solid " + C.border, overflow: "hidden" }}>
                    <table style={{ width: "100%", borderCollapse: "collapse" }}>
                        <thead>
                            <tr>
                                <th style={thStyle} onClick={() => handleSort("product")}>
                                    Projet{sortIndicator("product")}
                                </th>
